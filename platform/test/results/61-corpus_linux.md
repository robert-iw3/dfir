...
| ✅ PASS | and it is held by persistence_shell_init evidence, not movement (weight 0.4511) |
| ✅ PASS | ci-runner-01 is a member with no movement record anywhere |
| ✅ PASS | and it is held by persistence_cron evidence, not movement (weight 0.3828) |
