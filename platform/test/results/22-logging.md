...
- Run: `uat_logging.sh` — 2026-08-17 13:09:37Z
...
| ✅ PASS | this run's own request is in it (2 line(s) carrying uat-logging-1786972178) |
...
| ✅ PASS | and one can be read back, 6189 bytes of it |
| ✅ PASS | labeled as an operational record and NOT evidence — it carries no custody seal and must not imply one |
