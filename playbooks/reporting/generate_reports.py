...
ATTACK_LABELS = {
    ...
    # Cloud control-plane / identity / exfil (AWS/Azure/GCP adjudicators + C6 data-plane).
    ...
    "T1562.007": "Modify cloud firewall",
    ...
    "T1205.002": "Socket filters (magic-packet C2)",
    # Linux memory / kernel TTPs (this toolkit's custom memory plugins).
    "T1055": "Process injection",
    "T1053": "Scheduled task/job",
    "T1068": "Privilege escalation (kernel)",
    "T1574.001": "GOT/PLT hijack",
    "T1611": "Escape to host (container)",
    "T1106": "Native API (io_uring)",
}
