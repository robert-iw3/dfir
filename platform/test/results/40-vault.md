...
- Run: `uat_vault.sh` — 2026-08-14 23:51:33Z
...
| Result | Assertion — with evidence |
|---|---|
| ✅ PASS | audit device is recording (5342433 bytes) |
...
| Result | Assertion — with evidence |
|---|---|
| ✅ PASS | agent rendered a Vault-minted database user (v-approle-ir-platf-bSccrQch3hXPILU4ejnd-1786750883) |
...
| ✅ PASS | Django logs in as the Vault dynamic user (v-approle-ir-platf-bSccrQch3hXPILU4ejnd-1786750883) |
...
| Result | Assertion — with evidence |
|---|---|
| ✅ PASS | rotation procedure completed (rotation complete: v-approle-ir-platf-bSccrQch3hXPILU4ejnd-1786750883 -> v-approle-ir-platf-BgdvrvQJSNbxmOIJ469A-1786751510) |
| ✅ PASS | a NEW credential was issued (v-approle-ir-platf-bSccrQch3hXPILU4ejnd-1786750883 -> v-approle-ir-platf-BgdvrvQJSNbxmOIJ469A-1786751510) |
| ✅ PASS | the old user was dropped from Postgres at rotation (v-approle-ir-platf-bSccrQch3hXPILU4ejnd-1786750883) |
| ✅ PASS | Django's live connection is on the new user (v-approle-ir-platf-BgdvrvQJSNbxmOIJ469A-1786751510) |
