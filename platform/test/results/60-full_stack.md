...
- Run: `uat_full_stack.sh` — 2026-08-17 23:36:05Z
...
| Result | Assertion — with evidence |
|---|---|
| ✅ PASS | data flow: collection run ingested (runs=181) |
| ✅ PASS | data flow: findings stored (findings=3242) |
| ✅ PASS | data flow: capture recorded in object store (captures=166) |
| ✅ PASS | data flow: true-positive adjudication preserved (tp=351) |
...
| ✅ PASS | platform name resolves to the broker (10.89.30.202) |
...
| ✅ PASS | the deployed accounts are still present and untouched (57 users) — this suite set no analyst password |
