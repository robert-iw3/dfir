...
SUITE=(
    ...
    "tiering:ir-enclave_backend_1"
    "scoping:ir-enclave_backend_1"
    "casework:ir-enclave_backend_1"
    "collab:ir-enclave_backend_1"
    "logging:ir-enclave_backend_1 ir-enclave_log-shipper_1"
    "health:ir-enclave_backend_1 ir-enclave_frontend_1"
    "lifecycle:ir-enclave_worker_1 ir-dmz_receiver_1"
