...
- Run: `uat_keycloak_db.sh` — 2026-08-12 13:58:10Z
...
| Result | Assertion — with evidence |
|---|---|
| ✅ PASS | read the application's rendered credential (v-approle-ir-platf-P2jJFFh67DNP7vZSFmRS-1786543057) |
...
| ✅ PASS | control: the application holds 10 live connection(s) to assert against |
...
| Result | Assertion — with evidence |
|---|---|
| ✅ PASS | Keycloak's rendered credential is Vault-issued (v-approle-keycloak-ZHLoWeqkOCMZDbCrpWL3-1786542770) |
