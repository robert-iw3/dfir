...
- Run: `uat_srg_webtier.sh` — 2026-08-15 00:10:23Z
...
| Result | Assertion — with evidence |
|---|---|
| ✅ PASS | SRG-APP-000125-WSR-000071: the deployed shipper completes a pass (4 object(s) shipped) |
...
| ✅ PASS | SRG-APP-000108-WSR-000166: the shipper's report is CURRENT (139s old) — a stale row is a reporter that stopped, which the existence check cannot tell from one that never started |
...
| ✅ PASS | SRG-APP-000001-WSR-000002: the login created server-side session state in Redis database 1 (64 -> 65 keys) |
