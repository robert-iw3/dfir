...
| `test/uat_casework.sh` | `test/lib/report.sh` | `enclave/backend` |
| `test/uat_collab.sh` | `test/lib/report.sh` | `enclave/backend` |
...
| `test/uat_health.sh` | `test/lib/report.sh` | `enclave/backend`<br>`enclave/frontend` |
...
| `test/uat_lifecycle.sh` | `test/lib/corpus_pipeline.sh`<br>`test/lib/report.sh` | `enclave/backend` |
...
| `Handover` | `handover` |
| `HostDetail` | `hostOverview` → `/api/hosts/` |
...
| `uat_casework.sh` | `enclave/backend` |
| `uat_collab.sh` | `enclave/backend` |
...
| `uat_health.sh` | `enclave/backend`, `enclave/frontend` |
